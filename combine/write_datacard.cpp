...
void write_datacard(TString datacard_name, TString cut_name, int year, TString dir){
    ...
    if (dir.Contains("all") && !dir.Contains("but_QCD"))
    {
        sys_saved = {"jes_Absolute", Form("jes_Absolute_%d", year), "jes_FlavorQCD", "jes_BBEC1", 
                    ...
                    Form("qshape_m3j_%d", year), Form("qshape_m4j_%d", year), Form("qshape_e3j_%d", year), Form("qshape_e4j_%d", year),
                    Form("wshape_m3j_%d", year), Form("wshape_m4j_%d", year), Form("wshape_e3j_%d", year), Form("wshape_e4j_%d", year)};
    ...
    if (dir.Contains("noQCD"))
        pro_drop.push_back("QCD");
