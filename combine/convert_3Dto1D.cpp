...
void convert_3Dto1D(TString datacard_name, TString cut_name, int year){
    ...
    if(datacard_name == "datacard/original/"){
        ...
        ycut_user = {0.0, 0.4, 1.0, 2.0};
        xbins_user = {{0,300,340,380,420,460,500,600,3000}, {0,300,350,400,450,500,550,600,700,800,3000}, 
                               {0,400,450,500,550,600,650,700,800,1000,3000}, {0,550,650,700,750,800,900,1000,1200,3000}};
        likelihood_cut = 1000;
    }
