...
private:
    ...
    Float_t wh_px, wh_py, wh_pz, wh_E;
    Float_t wl_px, wl_py, wl_pz, wl_E;
    // Float_t neutrino_pz;
    ...
    Float_t atop_pt, atop_eta, atop_phi, atop_mass;
    ...
    bool jet_veto;
    bool is_form_gen_jet(TLorentzVector mom);
    bool is_jet_from_pfmuon(TLorentzVector mom);
public:
    static TF1 *h_ecorr;
    static TH2D *jet_veto_map;
...
TH2D *select_tree::jet_veto_map = NULL;